<div class="main_header ">
    ...
    <div class="dialog_search" id="dialog">
        <div class="btn_cancel" onclick="show_search(this,2)">
            <img src="/images/icons8-cancel-50.png" alt="Đóng">
        </div>
        <form class="form_sub" id="search" method="get" action="/search">
            <img class="img_seach_sub" id="img_search_sub" src="/images/icons8-search-64.png" alt="Tìm kiếm">
            ...
            <nav class="nav_menu">
                ...
                <ul class="list_menu" id="list_menu">
                    ...
                    foreach ($menu_cate_parent as $val) {
                        ...
                        <li class="this_menu">
                            <div class="item_menu" onclick="show_submenu(this,1)">
                                ...
                                <img class="icon_forward" src="/images/icons8-forward-30.png" alt="icon forward">
                            </div>
                            <?php if ($menu_cate != null) { ?>
                                <div class="menu_con">
                                    <ul>
                                        <li class="li_back">
                                            <img class="icon_back" src="/images/icons8-forward-30.png" alt="icon forward" onclick="show_submenu(this,2)">
                    ...
                    <li class="this_menu menu_search">
                        <img class="icon_search" src="/images/icons8-search-30.png" alt="icon search" onclick="show_search(this,1)">
                    </li>
                    <li class="list_contact">
                        ...
                        <a href="#">
                            <img class="tiktok" src="/images/tiktok.png" alt="tiktok">
                        </a>
                        <a href="#">
                            <img src="/images/mail.png" alt="facebook">
                        </a>
                        <a href="#">
                            <img src="/images/icons8-phone-30.png" alt="hotline">
                        </a>
                        <a href="#">
                            <img src="/images/icons8-youtube-30.png" alt="youtube">
                        </a>
                    </li>
                </ul>
